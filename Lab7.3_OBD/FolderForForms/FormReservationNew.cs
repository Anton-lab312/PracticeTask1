...
namespace Lab7._3_OBD
{
    public partial class FormReservationNew : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            string valueTour, valueHotel, valueAirline;
            try
            {
                valueTour = dictTour[comboBoxTour.Text];
                valueHotel = dictHotel[comboBoxHotel.Text];
                valueAirline = dictAirline[comboBoxAirline.Text];
            }
            catch
            {
                return;
